...
urlpatterns = [
    ...
    url(r'^workflows/printing/cheques/print/$', workflows.print_cheques_print,
        name='artshow-workflow-print-cheques-print'),
    url(r'^workflows/artist_checkout/$', workflows.find_artist_checkout,
        name='artshow-workflow-artist-checkout-lookup'),
    url(r'^workflows/artist_checkout/(?P<artistid>\d+)/$',
        workflows.artist_checkout, name='artshow-workflow-artist-checkout'),
    url(r'^workflows/artist_checkout/(?P<artistid>\d+)/control_form$',
