...
urlpatterns = [
    ...
    url(r'^entry/bidders/$', addbidder.bulk_add, name='artshow-bulk-add-bidders'),
    url(r'^entry/bids/$', addbidder.bid_bulk_add, name='artshow-bulk-add-bids'),
    url(r'^entry/auction_bids/(?P<adult>[yn])/$', voice_auction.auction_bids),
    url(r'^entry/order_auction/(?P<adult>[yn])/$', voice_auction.order_auction, name='artshow-voice-auction-order'),
    ...
    url(r'^reports/winning-bidders/$', reports.winning_bidders, name='artshow-report-winning-bidders'),
    url(r'^reports/artist-panel-report/$', reports.artist_panel_report, name='artshow-report-artist-to-panel'),
    url(r'^reports/panel-artist-report/$', reports.panel_artist_report, name='artshow-report-panel-to-artist'),
    url(r'^reports/artist-payment-report/$', reports.artist_payment_report, name='artshow-report-artist-payment'),
    ...
    url(r'^cashier/invoice/(?P<invoice_id>\d+)/$', cashier.cashier_invoice, name='artshow-cashier-invoice'),
    ...
    url(r'^reports/winning-bidders-pdf/$', pdfreports.winning_bidders, name='artshow-winning-bidders-pdf'),
    url(r'^reports/bid-entry-by-location-pdf/$', pdfreports.bid_entry_by_location),
    url(r'^reports/artists-csv/$', csvreports.artists, name='artshow-artists-csv'),
    url(r'^reports/pieces-csv/$', csvreports.pieces, name='artshow-pieces-csv'),
    url(r'^reports/bidders-csv/$', csvreports.bidders, name='artshow-bidders-csv'),
    url(r'^reports/payments-csv/$', csvreports.payments, name='artshow-payments-csv'),
    url(r'^reports/cheques-csv/$', csvreports.cheques, name='artshow-cheques-csv'),
    ...
    url(r'^workflows/printing/$', workflows.printing, name='artshow-workflow-printing'),
]
